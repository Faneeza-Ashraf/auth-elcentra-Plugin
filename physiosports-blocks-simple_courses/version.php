 ...
 * @copyright  2025 Faneeza Muskan <faneeza.muskan@paktaleem.net>2025 
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
*/

defined('MOODLE_INTERNAL') || die();

$plugin->component = 'block_simple_courses';
$plugin->version   = 2025081901; // Use current date YYYYMMDDXX
