...
/**
* The form for a student to submit their presentation file.
*
...
// File manager for submission.
$mform->addElement('filemanager', 'submission_files', get_string('uploadafile', 'mod_presentation'), null, $fileoptions);
