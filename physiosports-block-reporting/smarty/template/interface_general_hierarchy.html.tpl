  ...
  <form action="general.php" method="get" name="search">
	...
	<table class='general-report'>
	  ...
	  <tr>
		<td class="py-2"><strong>{php} print_string('completionmenuitem', 'core_completion'); {/php}</strong></td>
		<td class="py-2">
	...
	<tr>
	  ...
	  <tr>
		<td class="py-2"></td>
		<td class="py-2">
		  <input type="submit" value="{php} print_string('go', 'block_reporting') {/php}"/>
		</td>
	  </tr>
	</table>
  </form>
