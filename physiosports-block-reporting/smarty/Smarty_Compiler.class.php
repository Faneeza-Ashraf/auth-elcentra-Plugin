 ...
 * @version 2.6.26 (Patched for PHP 8.x)
...
class Smarty_Compiler extends Smarty {
    ...
    /**
     * This is the code of the plugins file
     * @var string
     */
    var $_plugins_code = ''; // FIX: Declared property to prevent dynamic creation warning
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $ldelim = $this->_quote_replace($this->left_delimiter);
        $rdelim = $this->_quote_replace($this->right_delimiter);

        $source_content = preg_replace_callback(
            $search,
            function ($matches) use ($ldelim, $rdelim) {
                return $ldelim . 'php'
        ...
        // FIX: Replaced deprecated strftime() with date()
    ...
    // SNIP ... THE REST OF THE FILE REMAINS THE SAME ...
...
next($this->_folded_blocks);
    ...
    function _compile_if_tag($tag_args, $elseif = false)
    {
        ...
        if(isset($token_count['(']) && (!isset($token_count[')']) || $token_count['('] != $token_count[')'])) {
