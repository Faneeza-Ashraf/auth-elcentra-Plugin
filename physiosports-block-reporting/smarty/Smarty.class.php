 ...
 */
    ...
    /**
     * FIX: Declare $_cache_include_info to prevent dynamic property creation error.
     *
     * @var array|null
     */
   ...
   /**
    ...
    function _parse_resource_name(&$params)
    {
        ...
        if (count($_resource_name_parts) == 1) {
            ...
            if(preg_match('/^[a-zA-Z]:$/', $_resource_name_parts[0])) {
                // 1 char is not resource type, but part of filepath (Windows)
                $params['resource_type'] = $this->default_resource_type;
