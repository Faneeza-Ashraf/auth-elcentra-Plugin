{*
  This is the filter interface for the Course Overview report.
*}
{php} global $OUTPUT; echo $OUTPUT->heading(ucwords(get_string('course_overview_reports', 'block_reporting'))) {/php}
...
<form action="courseoverview.php" method="get" name="search">
    ...
    <table>
        ...
        {* FIX: Added a check to ensure the array is not empty before looping *}
        ...
        {* FIX: Added a check to ensure the array is not empty before looping for robustness *}
