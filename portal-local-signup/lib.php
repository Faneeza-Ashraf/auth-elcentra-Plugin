...
abstract class signup_moodleform extends moodleform {
 ...
 */
class signup_select_form extends company_moodleform {
    protected $title = '';
...
function signup_fix_breadcrumb(&$PAGE, $linktext, $linkurl) {
 ...
 */
function local_signup_inplace_editable($itemtype, $itemid, $newvalue) {
 ...
 */
function local_signup_pluginfile($course, $birecord_or_cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    global $DB, $CFG, $USER;
 ...
 */
function local_signup_render_navbar_output(\renderer_base $renderer) {
    global $USER, $CFG;
