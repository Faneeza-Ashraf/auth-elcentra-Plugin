...
/**
 * Twitter OAuth request handler for auth_elcentra plugin.
 *
...
// Twitter OAuth configuration loaded from plugin settings
$twitterConfig = array(
...
// Create Twitter OAuth handler and start the OAuth flow
