...
class display_table {
    ...
    protected $base_url;
     ...
     /**
     * The name of the URL parameter for the sort column.
     * @var string
     */
    protected $sort_param;  //Added by Faneeza Muskan

    /**
     * The name of the URL parameter for the sort direction.
     * @var string
     */
    protected $sortdir_param;  //Added by Faneeza Muskan
                ...
                if ($column['sortable'] === true) {
                    ...
                    return html_writer::link(new moodle_url($this->base_url,
                       ...
                       // . ' ' . html_writer::empty_tag('img', array('src' => $OUTPUT->image_url('t/down')));
                        . ' ' . $OUTPUT->pix_icon('t/down', get_string('sortdesc', 'moodle')); //Updated by Faneeza Muskan
                    ...
                    return html_writer::link(new moodle_url($this->base_url,
                       ...
                       // . ' ' . html_writer::empty_tag('img', array('src' => $OUTPUT->image_url('t/up')));
                        . ' ' . $OUTPUT->pix_icon('t/up', get_string('sortasc', 'moodle'));  //Updated by Faneeza Muskan
                } else {
...
class display_date_item {
     var $format;  //Added by Faneeza Muskan
