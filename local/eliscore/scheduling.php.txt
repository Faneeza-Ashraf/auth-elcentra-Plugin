...
class scheduling_form_step_schedule extends moodleform {
    use elisschedulingworkflowtrait;  //Added by Faneeza Muskan
    /**
     * The form definition.
     */
    function definition() {
        ...
        $group[] = $mform->createElement('radio', 'recurrencetype', '', get_string('simple_recurrence', 'local_eliscore'), self::$RECURRENCE_SIMPLE); //Updated by Faneeza Muskan
        ...
        $group[] = $mform->createElement('radio', 'recurrencetype', '', get_string('calendar_recurrence', 'local_eliscore'), self::$RECURRENCE_CALENDAR); //Updated by Faneeza Muskan
        ...
        $mform->setDefault('recurrencetype', self::$RECURRENCE_SIMPLE); //Updated by Faneeza Muskan
        ...
        $options = array(
            ...
            self::$FREQ_MIN   => get_string('freq_minutes', 'local_eliscore'),
            self::$FREQ_HOUR  => get_string('freq_hours', 'local_eliscore'),
            self::$FREQ_DAY   => get_string('freq_days', 'local_eliscore'),
            self::$FREQ_MONTH => get_string('freq_months', 'local_eliscore'),  //Updated by Faneeza Muskan
        );
        ...
        $mform->setDefault('frequencytype', self::$FREQ_DAY); //Updated by Faneeza Muskan
        ...
        $group[] = $mform->createElement('advcheckbox', 'allmonths', '', get_string('all'), 1);
        $group[] = $mform->createElement('static', '', '', '<br />');
        $group[] = $mform->createElement('checkbox', 'month[1]', '', userdate(mktime(0, 0, 0, 1, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[2]', '', userdate(mktime(0, 0, 0, 2, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[3]', '', userdate(mktime(0, 0, 0, 3, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[4]', '', userdate(mktime(0, 0, 0, 4, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[5]', '', userdate(mktime(0, 0, 0, 5, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[6]', '', userdate(mktime(0, 0, 0, 6, 1), '%b'));
        $group[] = $mform->createElement('static', '', '', '<br />');
        $group[] = $mform->createElement('checkbox', 'month[7]', '', userdate(mktime(0, 0, 0, 7, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[8]', '', userdate(mktime(0, 0, 0, 8, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[9]', '', userdate(mktime(0, 0, 0, 9, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[10]', '', userdate(mktime(0, 0, 0, 10, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[11]', '', userdate(mktime(0, 0, 0, 11, 1), '%b'));
        $group[] = $mform->createElement('checkbox', 'month[12]', '', userdate(mktime(0, 0, 0, 12, 1), '%b'));
        $mform->addGroup($group, 'month', get_string('months', 'local_eliscore'), '', false);  //Updated by Faneeza Muskan
