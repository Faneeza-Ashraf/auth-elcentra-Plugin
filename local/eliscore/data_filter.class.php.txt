...
class in_list_filter extends data_filter {
     ...
     */
     ...
     /**
     * @var string The local field to filter on.
     */
    protected $local_field;  //Added by Faneeza Muskan

    /**
     * @var array The list of values to check against.
     */
    protected $list;  //Added by Faneeza Muskan

    /**
     * @var bool Whether to use 'NOT IN' instead of 'IN'.
     */
    protected $not_in; //Added by Faneeza Muskan
