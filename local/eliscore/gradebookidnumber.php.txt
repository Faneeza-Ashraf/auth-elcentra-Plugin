...
class elis_gradebook_idnumber_selector extends MoodleQuickForm_text {
    ...
    const NAME = 'elis_gradebook_idnumber_selector';
       ...
       /**
     * @var bool Whether to append the name attribute to the element.
     */
    protected $_appendName;  //Added by Faneeza Muskan
    ...
    public function __construct($elementName=null, $elementLabel=null, $options=array(), $attributes=null) {
        ...
        $this->_options['nocoursestring'] = get_string('nocourseselected', 'local_eliscore');
