...
$string['subplugintype_eliscore_plural'] = 'ELIS Core Subplugins';  // Added by Faneeza Muskan
$string['subplugintype_elisfields'] = 'ELIS Core Field';  // Added by Faneeza Muskan
 $string['subplugintype_eliscore'] = 'ELIS Core Subplugin';  // Added by Faneeza Muskan